...
public class TaskStatusGetResponse {
    ...
    public TaskStatusGetResponse() {
    }

    public TaskStatusGetResponse(String courseid, String cur_task, String task1_0, String task1_1, String task2, String task3, String task4) {
