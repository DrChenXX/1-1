...
public class KaikexiangqingRequest {
    ...
    public KaikexiangqingRequest() {
    }

    public KaikexiangqingRequest(String peiyangfanganid, String kechengmingcheng, String kechengbianhao, String kechengleibie, String shangchuan, String yeshu) {
