...
public class FeedbackOfBiyeyaoqiuResponse {
    ...
    public FeedbackOfBiyeyaoqiuRespons() {
    }

    public FeedbackOfBiyeyaoqiuRespons( private String zhichengdian,boolean is_zhicheng,String xiugai,String yijian;) {
    ...
    public String toString() {
        return "FeedbackOfBiyeyaoqiuResponse{" +
