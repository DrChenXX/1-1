...
//    }
    ...
    public RestResponse task13kechengmubiao_getRequest(@RequestHeader(value = "token",required = false)String token,@RequestBody Task13Kechengmubiao_getRequest request) {
        System.out.println(request);
        return sessionManager.getSession(token).getTeacherService().task13Kechengmubiao_get(request);
    }
    
    @ResponseBody
    @RequestMapping(path = "/task1-4_get_header", method = RequestMethod.POST)
    public void task14getHeade(@RequestHeader(value = "token",required = false)String token,@RequestBody Task14GetHeadRequest request) {
        System.out.println(request);
        sessionManager.getSession(token).getTeacherService().task14GetHead(request);
    }

    @ResponseBody
    @RequestMapping(path = "/task1-4_get_body", method = RequestMethod.POST)
    public void task14getBody(@RequestHeader(value = "token",required = false)String token,@RequestBody Task14GetBodyRequest request) {
        System.out.println(request);
        sessionManager.getSession(token).getTeacherService().task14GetBody(request);
    }
    
    @ResponseBody
    @RequestMapping(path = "/task1-4_send_body", method = RequestMethod.POST)
    public void task14sendBody(@RequestHeader(value = "token",required = false)String token,@RequestBody List<Task14SendBodyRequest> requests) {
        System.out.println(requests);
        sessionManager.getSession(token).getTeacherService().task14SendBody(requests);
    }
    ...
    @RequestMapping(path = "/task3-1_get", method = RequestMethod.POST)
    public RestResponse task31fenshuzhanbi_getRequest(@RequestHeader(value = "token",required = false)String token,@RequestBody Task31Fenshuzhanbi_getRequest request) {
        System.out.println(request);
        return sessionManager.getSession(token).getTeacherService().task31Fenshuzhanbi_get(request);
    }

    @ResponseBody
    @RequestMapping(path = "/task3-1_send", method = RequestMethod.POST)
    public void task31fenshuzhanbi_sendRequest(@RequestHeader(value = "token",required = false)String token,@RequestBody List<Task31Fenshuzhanbi_sendRequest> requests) {
        System.out.println(requests);
        sessionManager.getSession(token).getTeacherService().task31Fenshuzhanbi_send(requests);
    }
    @ResponseBody
